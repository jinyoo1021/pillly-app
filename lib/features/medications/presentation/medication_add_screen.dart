...
class MedicationAddScreen extends ConsumerStatefulWidget {
  const MedicationAddScreen({super.key});

  @override
  ConsumerState<MedicationAddScreen> createState() =>
      _MedicationAddScreenState();
}

class _MedicationAddScreenState extends ConsumerState<MedicationAddScreen> {
  ...
  Future<void> _onSave() async {
    ...
    final request = MedicationCreateRequest(
      ...
      weekdays: _cycleType == CycleType.weekly
    ...
    final success =
    await ref.read(medicationCreateProvider.notifier).create(request);
    ...
    if (success) {
      ...
      _showError('Failed to save medication. Please try again.');
    }
  }
  ...
  Widget build(BuildContext context) {
    final isLoading = ref.watch(medicationCreateProvider).isLoading;
          ...
          children: [
            ...
            ..._times.asMap().entries.map((entry) {
              ...
              return _TimeRow(
                ...
                onDelete: () => setState(() => _times.removeAt(index)),
              );
            }),
